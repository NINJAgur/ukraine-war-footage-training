"""
shared/db/models.py
SQLAlchemy ORM models shared across all services (ml-engine, scraper-engine, web-app).
"""
import enum
...
class TrainingRun(Base):
    ...
    dataset_ids = Column(JSON)
    weights_path = Column(String(2000))
    baseline_weights = Column(String(2000))
    metrics = Column(JSON)
    error_message = Column(Text)
