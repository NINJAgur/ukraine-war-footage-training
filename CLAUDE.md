...
4. VEHICLE: baseline run 25 (0.871) → finetune run 76 (0.904, Kaggle-only) → scraped finetune run 78 (0.902) ✅
5. PERSONNEL: baseline run 29 (0.780) → finetune run 74 (0.872) → finetune run 75 (0.873) ✅
6. GENERAL: baseline run 30 (0.784) → scraped finetune run 79 (0.851) ✅
