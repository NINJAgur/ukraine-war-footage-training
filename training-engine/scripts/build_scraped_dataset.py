...
Output:
    training-engine/media/scraped_datasets/<YYYY-MM-DD>/
        train/images/   train/labels/
        val/images/     val/labels/
        dataset.yaml

Usage (from repo root):
    cd training-engine && python scripts/build_scraped_dataset.py
    cd training-engine && python scripts/build_scraped_dataset.py --date 2026-05-07
    cd training-engine && python scripts/build_scraped_dataset.py --keep-frames
"""
import sys
import shutil
import logging
