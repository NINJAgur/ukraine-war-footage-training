"""
training-engine/scripts/autolabel_kaggle.py
...
Usage:
    cd training-engine
    python scripts/autolabel_kaggle.py --path /path/to/images --output-dir /path/to/output
    python scripts/autolabel_kaggle.py --path media/kaggle_datasets/nzigulic/.../train/images
    python scripts/autolabel_kaggle.py --path media/kaggle_datasets/some_dataset --max-images 5000
    python scripts/autolabel_kaggle.py --path ... --prompt "tank . drone . soldier"
"""
import argparse
import logging
import shutil
