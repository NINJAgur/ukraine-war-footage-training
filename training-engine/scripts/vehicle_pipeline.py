...
Usage:
    cd training-engine && python scripts/vehicle_pipeline.py [limit]
    from scripts.vehicle_pipeline import run; run(limit=10)
"""
import sys
import logging
    ...
    with get_session() as session:
        ...
        for clip in candidates:
            ...
            _, det_counts = infer_video_multi_model(
                [(model, "VEHICLE", COLOR)], str(raw_path), save_path=str(temp_out),
            ...
            clip.mp4_path = finalize_clip(clip, temp_out, "VEHICLE")
