"""
training-engine/tests/test_daily_pipeline_e2e.py
...
Usage:
    cd training-engine && python tests/test_daily_pipeline_e2e.py
    cd training-engine && python tests/test_daily_pipeline_e2e.py --keep
"""
...
def main():
    parser = argparse.ArgumentParser(description="training-engine daily pipeline E2E test")
